...
export const useGetTokenApprovalsForAddress = ({
    ...
    const refetch = useCallback(
        async (isRevalidate = false) => {
            ...
            await apiService.SecurityService.getApprovals(
                chainName,
                walletAddress
            ).then((data) => {
...
export default useGetTokenApprovalsForAddress;
