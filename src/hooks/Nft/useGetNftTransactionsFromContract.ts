...
import type { NftTransactionsResponse } from "@covalenthq/client-sdk";
import type { IGetNftTransactionsFromContract } from "../../types";
import { CovalentClient } from "@covalenthq/client-sdk";
import { CovalentAPIContext } from "../../providers";
import { revalidateTime } from "../../helpers";

export const useGetNftTransactionsFromContract = ({
    chainName,
    contractAddress,
    tokenId,
    options,
    revalidate = true,
}: IGetNftTransactionsFromContract) => {
    const [data, setData] = useState<NftTransactionsResponse>();
    ...
    const refetch = useCallback(
        async (isRevalidate = false) => {
            ...
            await apiService.NftService.getNftTransactionsForContractTokenId(
                chainName,
                contractAddress,
                tokenId,
                options
...
export default useGetNftTransactionsFromContract;
