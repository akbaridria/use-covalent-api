...
import type { TransactionResponse } from "@covalenthq/client-sdk";
import type { IGetATransaction } from "../../types";
import { CovalentClient } from "@covalenthq/client-sdk";
import { CovalentAPIContext } from "../../providers";
import { revalidateTime } from "../../helpers";

export const useGetATransaction = ({
    chainName,
    txHash,
    options,
    revalidate = true,
    ...
    const refetch = useCallback(
        async (isRevalidate = false) => {
            ...
            await apiService.TransactionService.getTransaction(
                chainName,
                txHash,
                options
            ).then((data) => {
...
export default useGetATransaction;
